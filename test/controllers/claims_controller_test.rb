...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { content: @claim.content, title: @claim.title, user_id: @claim.user_id } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { content: @claim.content, title: @claim.title, user_id: @claim.user_id } }
